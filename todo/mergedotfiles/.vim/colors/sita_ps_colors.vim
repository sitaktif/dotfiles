...
if s:style=='warm' 
  ...
  highlight SignColumn          guifg=#686868	guibg=bg
  ...
  highlight Pmenu		guifg=fg	guibg=#a6caf0
...
elseif s:style=='cool' 
  ...
  highlight Normal		guifg=#d0d0d0	guibg=#161616
  ...
  highlight SignColumn          guifg=#b0b0b0	guibg=bg
  ...
  highlight Pmenu               guifg=#000000	guibg=#a6caf0   ctermbg=brown 
  highlight PmenuThumb          gui=reverse
