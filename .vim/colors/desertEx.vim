...
hi Normal	guifg=gray guibg=grey12 gui=none
...
hi CursorLine   guibg=gray24         gui=none
...
hi Visual       guifg=gray12         guibg=tan3     gui=none
hi WarningMsg   guifg=salmon         gui=none
hi Pmenu        guifg=white          guibg=#445599  gui=none
hi PmenuSel     guifg=#445599        guibg=gray
hi WildMenu     guifg=gray           guibg=gray12   gui=none
" Personal supplementary colors
hi TabLine guifg=Gray14
hi TagListFileName ctermfg=15 ctermbg=8 guifg=white guibg=Grey24
